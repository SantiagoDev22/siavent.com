...
<main>
    ...
    <section class=" relative ">
        ...
        <div class=" absolute flex items-start container z-20 flex-col justify-center inset-0">
            ...
            <a href="" class=" px-[20px] py-[10px] mt-10 rounded-[25px] bg-[#E73636] hover:bg-[#032039] text-white font-poppins text-xl font-medium">Cotiza Ahora</a>
        ...
        <div class=" container relative z-20">
            <div class=" flex items-center justify-between lg:flex-row flex-col lg:gap-x-[124px] ">
                <div class=" lg:flex-1 flex flex-col lg:items-start  items-start">
                    ...
                    <a href="" class=" px-[20px] rounded-[25px] mt-10 border-[#E73636] bg-transparent hover:bg-[#E73636] hover:text-white text-[#E73636] font-medium text-xl font-poppins border-[2px] hover:border-transparent py-[10px]">Habla con un experto</a>
                </div>
                <div class="w-full lg:flex-1">
                    ...
                    <div class="hidden lg:grid grid-cols-2 gap-x-5">
                        <div class="flex lg:flex-col flex-row gap-y-5 items-center justify-center">
                            <div class="shadow-md rounded-[40px]">
                                <figure class="border-white border-[10px] rounded-[32px]">
                                    <img class="w-auto lg:h-[292px] bg-cover object-cover rounded-[32px]" loading="lazy" src="<?= base_url('images/landing/home/image-1.webp') ?>" alt="">
                                </figure>
                            </div>
                            <div class="shadow-md rounded-[40px]">
                                <figure class="border-white border-[10px] rounded-[32px]">
                                    <img class="w-auto lg:h-[292px] bg-cover object-cover rounded-[32px]" loading="lazy" src="<?= base_url('images/landing/home/image-2.webp') ?>" alt="">
                                </figure>
                            </div>
                            <div class="shadow-md rounded-[40px]">
                                <figure class="border-white border-[10px] rounded-[32px]">
                                    <img class="w-auto lg:h-[292px]" loading="lazy" src="<?= base_url('images/landing/home/image-3.webp') ?>" alt="">
                                </figure>
                            </div>
                        </div>
                        ...
                        <div class="flex lg:flex-col flex-row items-center gap-y-5 justify-center">
                            <div class="shadow-md rounded-[40px]">
                                <figure class="border-white border-[10px] rounded-[32px]">
                                    <img class="w-auto lg:h-[292px] bg-cover object-cover rounded-[32px]" loading="lazy" src="<?= base_url('images/landing/home/image-4.webp') ?>" alt="">
                                </figure>
                            </div>
                            <div class="shadow-md rounded-[40px]">
                                <figure class="border-white border-[10px] rounded-[32px]">
                                    <img class="w-auto lg:h-[292px] bg-cover object-cover rounded-[32px]" loading="lazy" src="<?= base_url('images/landing/home/image-5.webp') ?>" alt="">
                                </figure>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="lg:hidden overflow-x-auto py-4 scroll-hidden">
            ...
            <div class=" container">
                ...
                <div class=" flex items-center justify-center lg:gap-x-[124px] lg:flex-row flex-col lg:mt-20 mt-10">
                    ...
                    <div class=" flex flex-col lg:items-start items-start lg:flex-1 lg:order-2 order-1">
                        ...
                        <a href="" class="px-[20px] py-[10px] rounded-[24px] bg-white text-[#E73636] hover:text-white hover:bg-[#E73636] font-poppins mt-10 text-xl font-medium transition-all ease-in-out duration-300">Contáctanos</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class=" relative">
        ...
        <div class=" container lg:pt-[120px] relative z-20 pt-[80px]">
            ...
            <div class=" flex items-start">
                <a href="" class=" px-[20px] py-[10px] rounded-[25px] border-2 border-[#E73636] hover:border-transparent text-[#E73636] font-medium text-xl hover:text-white bg-transparent hover:bg-[#E73636] transition-all ease-in-out duration-300 font-poppins mt-[42px]">Contacta a un asesor</a>
            </div>
                ...
                <div class=" lg:max-w-[450px] w-full">
                    <div class=" flex flex-col items-center justify-center w-full lg:mt-0 mt-[60px]">
                        ...
                        <div class=" flex items-center gap-x-5 justify-center w-full mt-5">
                            ...
                            <select name="" id="" class="rounded-[24px] w-full text-base text-[#093B57] placeholder:text-base placeholder:text-[#093B57] placeholder:font-medium px-[16px] py-[10px]">
                        ...
                        <a href="" class=" px-[20px] py-[10px] rounde-[25px] w-full rounded-[25px] text-center mt-10 transition-all ease-in-out duration-300 bg-[#E73636] hover:text-[#E73636] hover:bg-white text-white font-poppins font-medium text-xl">Enviar</a>
                    </div>
                </div>
            </div>
        </div>
