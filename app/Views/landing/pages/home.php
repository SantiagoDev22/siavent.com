...
<main>
    ...
    <section class=" relative ">
        ...
        <div class="relative z-10">
            <figure>
                ...
                <div class=" absolute w-full h-full top-0 bg-gradient-to-r from-[#093B57] to-transparent"></div>
                <!-- Added image -->
        ...
        <div class=" absolute flex items-start container z-20 flex-col justify-center inset-0">
            <h1 class=" uppercase text-white lg:text-[34px] leading-[140%] lg:max-w-[708px] text-[28px] font-poppins font-extrabold">
                <?= esc($landing['title']) ?>
            </h1>
            <h2 class=" uppercase text-white lg:text-[28px] leading-[140%] lg:max-w-[708px] text-[24px] font-poppins font-extrabold mt-5">
        ...
        <div class=" container relative z-20">
            <div class=" flex items-center justify-between lg:flex-row flex-col lg:gap-x-[124px] ">
                <div class=" lg:flex-1 flex flex-col lg:items-start  items-start">
                    ...
                    <ul class=" grid lg:grid-cols-2 grid-cols-1 gap-y-4 mt-5 auto-rows-[30px]">
    ...
    <footer class=" bg-[#032039]">
        <p class=" lg:text-base text-sm font-poppins text-center py-4 text-white  lg:px-0 px-7">Sia Ventilación® Todos los derechos reservados 2025 • Política de privacidad <br class=" lg:block hidden ">
            Diseño y desarrollo por Leads al Cubo
        </p>
        <a href="https://develogy.com.mx/" target="_blank" rel="nofollow noreferrer noopener" class="hover:font-medium transition-all hidden">
            Powered by Develogy&reg;
        </a>
    </footer>
    <a href="<?= esc(setting()->get('App.apps', 'whatsapp')) ?>" target="_blank" class="fixed lg:bottom-8 lg:right-9 right-4 bottom-3 z-40 group">
