                    ...
                    <div class=" lg:max-w-[450px] w-full">
                        <div class=" flex flex-col items-center justify-center w-full lg:mt-0 mt-[60px]">
                            ...
                            <div class="mt-6 text-center lg:text-left">
                                <button type="submit" class="px-[20px] py-[10px] rounde-[25px] w-full rounded-[25px] text-center mt-10 transition-all ease-in-out duration-300 bg-[#E73636] hover:text-[#E73636] hover:bg-white text-white font-poppins font-medium text-xl flex items-center justify-center">
