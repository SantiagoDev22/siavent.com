...
<main>
    ...
    <section class=" relative ">
        ...
        <div class=" absolute flex items-start container z-20 flex-col justify-center inset-0">
            <h1 class=" uppercase text-white lg:text-[34px] leading-[140%] max-w-lg text-[28px] font-poppins font-extrabold">
                <?= esc($landing['title']) ?>
            </h1>
            <h2 class=" uppercase text-white lg:text-[28px] leading-[140%] max-w-lg text-[24px] font-poppins font-extrabold mt-5">
